...
namespace CNSEquipmentLogger
{
	...
	public partial class EquipInfoDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteEquipment(Equipment instance);
		...
		public EquipInfoDataContext() : 
				base(global::CNSEquipmentLogger.Properties.Settings.Default.EquipmentLogsConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public EquipInfoDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public EquipInfoDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public EquipInfoDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public EquipInfoDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnPurchasePriceChanging(string value);
    ...
    partial void OnVendorChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PurchasePrice", DbType="Text", UpdateCheck=UpdateCheck.Never)]
